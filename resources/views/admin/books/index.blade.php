...
@section('content')
<button type="button" class="btn btn-primary"> <a style="color: rgb(255, 255, 255); text-decoration: none;" href="{{ route('books.create') }}"><i class="fas fa-plus"></i> أضف كتابًا جديدًا</a></button>


<livewire:data-table type='publisher'/>
{{-- <hr>
<div class="row">
    <div class="col-md-12">
